            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <div class="d-md-flex">
                    <ol class="breadcrumb ms-auto">
                        <li><a href="{{ url('admin/template/list') }}" class="fw-normal">Template</a></li>
                    </ol>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-8 col-md-8 col-xs-8">
                        <form action="/admin/template/list" method="get">
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                        <a href="/admin/template/create" class="btn btn-primary btn-lg" style="margin-bottom: 30px">Create</a>
                    </div>
