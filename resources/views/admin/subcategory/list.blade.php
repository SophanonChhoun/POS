            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <div class="d-md-flex">
                    <ol class="breadcrumb ms-auto">
                        <li><a href="{{ url('admin/subcategory/list') }}" class="fw-normal">Sub Category</a></li>
                    </ol>
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                        <div class="form-group has-search">
                            <form action="/admin/subcategory/list" method="get">
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                        <a href="/admin/subcategory/create" class="btn btn-primary btn-lg" style="margin-bottom: 30px">Create</a>
                    </div>
        ...
        function updateOrder(item)
        {
            $('#input' + item.id).keypress(function (e) {
                if (e.which == 13) {
                    ...
                    axios.patch('http://127.0.0.1:8000/admin/subcategory/update/order/'+item.id, {
                        "sequence_order": order
                    })
                        .then(response => {
                            if(response.data.success) {
                                alert("You have already update order of " + item.description);
                            }else {
                                alert("You cannot update order of " + item.description);
                            }
                        })
