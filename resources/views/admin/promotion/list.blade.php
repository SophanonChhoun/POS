            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <div class="d-md-flex">
                    <ol class="breadcrumb ms-auto">
                        <li><a href="{{ url('admin/promotion/list') }}" class="fw-normal">Promotion</a></li>
                    </ol>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4" >
                        <a href="/admin/promotion/create" class="btn btn-primary btn-lg" style="margin-bottom: 30px">Create</a>
                    </div>
