                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                        <div class="form-group has-search">
                            <form action="/admin/faq_question/list" method="get">
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                        <a href="/admin/faq_question/create" class="btn btn-primary btn-lg" style="margin-bottom: 30px">Create</a>
                    </div>

                </div>
                <div class="table-responsive">
                    @include("admin.FAQQuestion.table")
        ...
        function updateOrder(item)
        {
            $('#input' + item.id).keypress(function (e) {
                if (e.which == 13) {
                    ...
                    axios.patch('http://127.0.0.1:8000/admin/faq_question/update/order/'+item.id, {
                        "order": order
                    })
                        .then(response => {
                            if(response.data.success) {
                                alert("You have already update order of this question" );
                            }else {
                                alert("You cannot update order of this question" );
                            }
                        })
