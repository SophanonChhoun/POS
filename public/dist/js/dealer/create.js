...
/* harmony import */ var _components_SingleSelect__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/SingleSelect */ "./resources/js/components/SingleSelect.vue");
...
new Vue({
  ...
  components: {
    ...
    SingleSelect: _components_SingleSelect__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  data: {
    data: {
      phone_number: '',
  ...
  methods: {
    submit: function submit() {
      ...
      this.$validator.validateAll().then(function (result) {
        ...
        if (result && save) {
          axios.post('/admin/dealer/create', _this.data).then(function (response) {
            ...
            _this.error = "Sorry there is something wrong";
          });
        } else {
...
/***/ 4:
/*!*********************************************!*\
  !*** multi ./resources/js/dealer/create.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/chhounsophanon/Desktop/kumnit/kumnit_backend/resources/js/dealer/create.js */"./resources/js/dealer/create.js");
