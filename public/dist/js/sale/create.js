  ...
  methods: {
    submit: function submit() {
      ...
      this.$validator.validateAll().then(function (result) {
        ...
        if (result && save) {
          axios.post('/admin/sale/create', _this.data).then(function (response) {
    ...
    setProduct: function setProduct(event, index) {
    ...
    getProductPrice: function getProductPrice(id, index) {
      if (id) {
        return this.products.find(function (product) {
          return product.id === id;
        }).price;
    ...
    getProductQuantity: function getProductQuantity(id) {
      if (id) {
        return this.products.find(function (product) {
          return product.id === id;
        }).quantity;
    ...
    getTotalDiscount: function getTotalDiscount() {
      ...
      if (this.data.promotion_id) {
        var promotion = this.promotions.find(function (promotion) {
          return promotion.id === _this2.data.promotion_id;
        });
        ...
        this.data.total = this.data.totalNotDiscount;
      }
...
/***/ 22:
/*!*******************************************!*\
  !*** multi ./resources/js/sale/create.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/chhounsophanon/Desktop/kumnit/kumnit_backend/resources/js/sale/create.js */"./resources/js/sale/create.js");
