  ...
  methods: {
    submit: function submit() {
      ...
      this.$validator.validateAll().then(function (result) {
        ...
        if (result && save) {
          axios.post('/admin/template/update/' + _this.id, _this.data).then(function (response) {
...
module.exports = __webpack_require__(/*! /Users/chhounsophanon/Desktop/kumnit/kumnit_backend/resources/js/template/edit.js */"./resources/js/template/edit.js");
