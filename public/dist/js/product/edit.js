...
/* harmony import */ var _components_SingleImageUploader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/SingleImageUploader */ "./resources/js/components/SingleImageUploader.vue");
...
new Vue({
  ...
  components: {
    ...
    SingleImageUploader: _components_SingleImageUploader__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: {
    data: data,
    id: data.id,
  ...
  methods: {
    submit: function submit() {
      ...
      this.$validator.validateAll().then(function (result) {
        ...
        if (result && save) {
          axios.post('/admin/product/update/' + _this.id, _this.data).then(function (response) {
    ...
    removeMedias: function removeMedias(index) {
...
/***/ 25:
/*!********************************************!*\
  !*** multi ./resources/js/product/edit.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/chhounsophanon/Desktop/kumnit/kumnit_backend/resources/js/product/edit.js */"./resources/js/product/edit.js");
