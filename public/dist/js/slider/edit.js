...
new Vue({
  ...
  methods: {
    ...
    removeBanner: function removeBanner(index) {
      this.data.splice(index, 1);
      this.data.forEach(function (item, i) {
        item.sort = i + 1;
      });
    },
    updateNews: function updateNews(index) {
      if (this.data[index].is_category) {
        this.data[index].is_category = !this.data[index].is_category;
      }
    },
    updateCategory: function updateCategory(index) {
...
/***/ 27:
/*!*******************************************!*\
  !*** multi ./resources/js/slider/edit.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/chhounsophanon/Desktop/kumnit/kumnit_backend/resources/js/slider/edit.js */"./resources/js/slider/edit.js");
