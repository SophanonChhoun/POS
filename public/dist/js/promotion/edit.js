...
/***/ "./resources/js/promotion/edit.js":
/*!****************************************!*\
  !*** ./resources/js/promotion/edit.js ***!
  \****************************************/
/*! no exports provided */
  ...
  methods: {
    submit: function submit() {
      ...
      this.$validator.validateAll().then(function (result) {
        ...
        if (result && save) {
          axios.post('/admin/promotion/update/' + _this.id, _this.data).then(function (response) {
    ...
    addContentText: function addContentText() {
    ...
    addContentImage: function addContentImage() {
      this.data.contents.push({
        image: '',
        is_text: false,
        sort: this.data.contents.length + 1
    ...
    removeContent: function removeContent(index) {
...
/***/ 17:
/*!**********************************************!*\
  !*** multi ./resources/js/promotion/edit.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/chhounsophanon/Desktop/kumnit/kumnit_backend/resources/js/promotion/edit.js */"./resources/js/promotion/edit.js");
